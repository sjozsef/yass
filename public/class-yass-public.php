...
class Yass_Public {
	...
	public function enqueue_styles() {
		...
		//wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/yass-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		if(isset($opts['YASS_enabled']) && $opts['YASS_enabled'])
		{
			wp_localize_script( $this->plugin_name, 'YASS_Settings', $opts );
